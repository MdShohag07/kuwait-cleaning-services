...
export const site = {
  ...
  whyPoints: [
    ...
    { icon: "check", title: { en: "Spotless guarantee", ar: "ضمان نظافة تامة" }, text: { en: "Not happy with a spot? We re-clean it free within 24 hours. No debate.", ar: "غير راضٍ عن بقعة ما؟ نعيد تنظيفها مجانًا خلال 24 ساعة، دون نقاش." } },
  ...
  steps: [
    { title: { en: "Book online", ar: "احجز عبر الإنترنت" }, text: { en: "Pick a service, date, and time in under 60 seconds.", ar: "اختر الخدمة والتاريخ والوقت في أقل من 60 ثانية." } },
  ...
  // demo — replace youtubeId with your own live-work video IDs
  videos: [
    {
  ...
  ] satisfies { youtubeId: string; title: Bi; length: Bi }[],
  beforeAfter: {
    cases: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: { en: "Anytime up to 12 hours before your slot, free of charge — just reply to your WhatsApp confirmation.", ar: "في أي وقت حتى 12 ساعة قبل موعدك، مجانًا — فقط رد على رسالة التأكيد عبر واتساب." },
    },
  ] satisfies { q: Bi; a: Bi }[],
  booking: {
    sizes: [
      { label: { en: "Studio / 1 room", ar: "استوديو / غرفة واحدة" }, mult: 1 },
      { label: { en: "2–3 rooms", ar: "2-3 غرف" }, mult: 1.4 },
      { label: { en: "4–5 rooms", ar: "4-5 غرف" }, mult: 1.9 },
      { label: { en: "Villa / large", ar: "فيلا / مساحة كبيرة" }, mult: 2.5 },
    ] satisfies { label: Bi; mult: number }[],
    freqs: [
      { label: { en: "One-time", ar: "لمرة واحدة" }, mult: 1 },
      { label: { en: "Weekly (-8%)", ar: "أسبوعي (خصم 8٪)" }, mult: 0.92 },
      { label: { en: "Bi-weekly (-5%)", ar: "كل أسبوعين (خصم 5٪)" }, mult: 0.95 },
    ] satisfies { label: Bi; mult: number }[],
