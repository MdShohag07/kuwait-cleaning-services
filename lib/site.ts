export const site = {
  ...
  services: [
    ...
    {
      name: "Deep Cleaning 2",
      desc: "Top-to-bottom detail with furniture, windows & build-up nobody else reaches. 2",
      price: 54,
      unit: "per property2",
      duration: "4–6 hours2",
      image: "/images/services/deep-cleaning.jpg",
      features: [
        "Full property deep clean2",
        "Furniture & upholstery2",
        "Interior windows & tracks2",
        "Detailed sanitization2",
      ],
      featured: false,
    },
     {
