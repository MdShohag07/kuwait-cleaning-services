...
const dict = {
  ...
  ar: {
    ...
    hero: {
      ...
      ratingCaption: "٤.٩ من ٥ · أكثر من ٦٠٠ تقييم",
      statHomesNum: "+٥٬٠٠٠",
      statHomesLabel: "منزل ومكتب تم تنظيفه",
      statGuaranteeNum: "١٠٠٪",
    ...
    blogPost: {
      ...
      ctaSub: "احجز {name} خلال ٦٠ ثانية — أسعار واضحة بالدينار الكويتي، فرق موثوقة، وضمان نظافة تامة.",
    },

    booking: {
      eyebrow: "احجز خلال ٦٠ ثانية",
      h2a: "لنجعلها",
      h2b: "نظيفة تمامًا",
      ...
      callSub: "اتصل بنا · السبت–الخميس، ٨ص – ٩م",
